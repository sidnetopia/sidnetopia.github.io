...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        # Compute the Euclidean distance for each test point and training point
    ...
    def compute_distances_one_loop(self, X):
        ...
        # Compute the Euclidean distance for each test point and training point using a single loop
        for i in range(num_test):
    ...
    def compute_distances_no_loops(self, X):
        ...
        # Compute the Euclidean distance for each test point and training point without using loops
        A = X
        B = self.X_train
