...
I used the naive forecasting approach. This
is to anticipate the future using current market price or
condition. The equation for the forecasting in this project is
Movementt = Movementt 􀀀 1.
