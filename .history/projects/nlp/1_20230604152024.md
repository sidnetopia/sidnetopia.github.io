...
<img src="images/nlp/1/movement_formula.png?raw=true"/>

    -   Here, __x__ represents __Open_t__ - __Close_t__ (the difference between the opening and closing prices), and __r__ is the threshold (in this case, 0.003). The Movementt can be categorized as an up, neutral, or down movement. This differs from [1] as my focus is on the movement rather than the actual price. It is also reasonable to consider the movement because small price changes may be insignificant due to higher transaction costs.
