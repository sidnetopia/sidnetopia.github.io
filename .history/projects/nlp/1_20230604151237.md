...
I employed SBERT (Sentence-BERT) [3] to convert textual data into sentence embeddings. I fine-tuned the model [4] to produce embeddings with a dimensionality of 768. Additionally, I generated document embeddings of size 50 using Doc2Vec [4], trained on the corpus.
