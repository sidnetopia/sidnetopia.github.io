...
First part of this project is building, selecting, and evluating models using the collected dataset. The second part of this to deploy the model in an application. This project works by first, having the children draw a man representation. The model then classifies the drawing according to the drawing's mental age (M1 for random or sketch drawings and M2-M16 for mental age of 2 to 16). Using the mental age classification along with the drawer's age, the IQ is computed by the system. This is according to the test admister by Goodenough, 1926.
