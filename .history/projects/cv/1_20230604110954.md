...
First part of this project is building, selecting, and evluating models using the collected dataset. The second part of this to deploy the model in an application. This project works by first, having the children draw a man representation. The model then classifies the drawing according to the drawing's mental age. Using the mental age classification along with the drawer's age, the IQ is computed by the system.
